...
def show_trips():
    ...
    user_trips=Trip.get_all_user_trips({'id':session['user_id']})
    trips=Trip.get_all_trips({'id':session['user_id']})
    
    return render_template("dashboard.html",user=user_to_show,user_trips=user_trips,trips=trips)
